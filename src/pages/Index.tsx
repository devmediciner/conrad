                    ...
                    <div className="relative overflow-hidden rounded-3xl border border-border/80 bg-card/40 p-6 md:p-8 shadow-sm flex flex-col justify-between min-h-[460px] h-full flex-1 group/card hover:border-primary/30 transition-all duration-300 backdrop-blur-md">
                      <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          <span className={`text-[9px] px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider border shadow-sm ${caseDaSemana.exam_type === 'RX' ? 'bg-blue-500/10 border-blue-500/25 text-blue-400' :
                        ...
                        <div className="relative overflow-hidden rounded-3xl border border-border bg-card p-6 shadow-sm flex flex-col justify-between min-h-[460px] h-full flex-1 group/card hover:border-primary/30 transition-all duration-300 backdrop-blur-md">
                          <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-2">
                              <span className={`text-[9px] px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider border shadow-sm ${artigoDaSemana.categoria === 'RX' ? 'bg-blue-500/10 border-blue-500/25 text-blue-400' :
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex bg-muted p-1 rounded-2xl w-full mb-6">
                        <button
                          ...
                          className={`flex-1 py-2 text-xs font-bold rounded-xl transition-all ${activeClassification === 'casos'
                        ...
                        <button
                          ...
                          className={`flex-1 py-2 text-xs font-bold rounded-xl transition-all ${activeClassification === 'geral'
                              ? 'bg-card text-foreground shadow-sm'
                              : 'text-muted-foreground hover:text-foreground'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`flex-1 py-2 text-xs font-bold rounded-xl transition-all ${activeClassification === 'anatomia'
                              ? 'bg-card text-foreground shadow-sm'
                              : 'text-muted-foreground hover:text-foreground'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`flex-1 py-2 text-xs font-bold rounded-xl transition-all ${activeClassification === 'patologia'
                              ? 'bg-card text-foreground shadow-sm'
                              : 'text-muted-foreground hover:text-foreground'
                            }`}
                        >
                            ...
                            {Object.entries(SYSTEM_LABELS).map(([key, label]) => {
                              ...
                              return (
                                <button
                                  ...
                                  disabled={count === 0}
                                  className={`group relative flex items-center justify-between p-4 rounded-2xl bg-card border border-border/60 shadow-sm transition-all duration-300 ${count > 0
